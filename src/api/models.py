...
class User(db.Model):
    ...
    # Sources: http://www.programcreek.com/python/example/92986/werkzeug.security.safe_str_cmp
    # http://stackoverflow.com/questions/59131067/what-is-the-purpose-of-safe-string-cmp
